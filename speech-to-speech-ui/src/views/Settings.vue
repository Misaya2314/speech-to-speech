          ...
          <div class="settings-section">
            ...
            <el-form label-position="top">
              <el-form-item label="STT模型 (语音转文本)">
                <el-select v-model="settings.sttModel" placeholder="选择STT模型">
                  <el-option
                ...
                <el-text type="info" size="small">负责将你的语音转换为文本</el-text>
              </el-form-item>
              ...
              <el-form-item label="LLM模型 (语言处理)">
                ...
                <el-text type="info" size="small">负责理解文本并生成回复</el-text>
              </el-form-item>
              
              <el-form-item label="TTS模型 (文本转语音)">
                <el-select v-model="settings.ttsModel" placeholder="选择TTS模型">
                  <el-option
                ...
                <el-text type="info" size="small">负责将回复文本转换为语音</el-text>
              </el-form-item>
            </el-form>
          </div>
        </el-tab-pane>
          ...
          <div class="settings-section">
            ...
            <el-form label-position="top">
              <el-form-item label="默认语言">
                <el-select v-model="settings.defaultLanguage" placeholder="选择默认语言">
                  <el-option
              ...
              <el-form-item label="语言检测">
                ...
                />
                <el-text type="info" size="small">启用后，系统将自动检测你说话的语言</el-text>
              </el-form-item>
            </el-form>
          </div>
        </el-tab-pane>
          ...
          <div class="settings-section">
            ...
            <el-form label-position="top">
              <el-form-item label="输入音量">
                <el-slider v-model="settings.inputVolume" :min="0" :max="100" :step="1" show-input />
              </el-form-item>
              
              <el-form-item label="输出音量">
                <el-slider v-model="settings.outputVolume" :min="0" :max="100" :step="1" show-input />
              </el-form-item>
              
              <el-form-item label="静音阈值">
                <el-slider v-model="settings.silenceThreshold" :min="0" :max="100" :step="1" show-input />
                <el-text type="info" size="small">调整系统对安静环境的敏感度</el-text>
              </el-form-item>
            </el-form>
          </div>
        </el-tab-pane>
          ...
          <div class="settings-section">
            ...
            <el-form label-position="top">
              <el-form-item label="服务器地址">
                <el-input v-model="settings.serverAddress" placeholder="例如: localhost 或 192.168.1.100" />
              </el-form-item>
              
              <el-form-item label="端口">
                <el-input-number v-model="settings.serverPort" :min="1" :max="65535" />
              </el-form-item>
              
              <el-form-item>
                <el-button type="primary" @click="testConnection">测试连接</el-button>
                <el-text v-if="connectionStatus" :type="connectionStatusType" class="connection-status">
...
export default defineComponent({
  ...
  setup() {
    ...
    const sttModels = [
      ...
      { label: 'Distil Whisper Large V3', value: 'distil-whisper/distil-large-v3' },
